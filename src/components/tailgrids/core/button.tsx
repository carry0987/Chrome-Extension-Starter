        ...
        compoundVariants: [
            {
                ...
                appearance: 'fill',
                className: 'text-white-100 disabled:bg-button-disabled-background disabled:text-button-disabled-text'
            },
            {
                variant: ['primary', 'danger', 'success'],
                appearance: 'outline',
...
export function Button({ variant, appearance, iconOnly, size, children, className, ...props }: PropsType) {
    return (
        <button
            type="button"
            className={cn(
