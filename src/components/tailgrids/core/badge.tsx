...
const badgeStyles = cva('inline-flex items-center gap-2 rounded-full font-medium [&>svg]:size-3', {
    variants: {
        ...
        color: {
            ...
            violet: 'bg-badge-violet-background text-badge-violet-text [&>svg]:text-badge-violet-icon-color',
            purple: 'bg-badge-purple-background text-badge-purple-text [&>svg]:text-badge-purple-icon-color',
            ...
            orange: 'bg-badge-orange-background text-badge-orange-text [&>svg]:text-badge-orange-icon-color'
        }
    },
    compoundVariants: [
        {
...
export function Badge({ color, size, className, prefixIcon, suffixIcon, children, ...props }: PropsType) {
    return (
        <span
            className={cn(
                badgeStyles({
